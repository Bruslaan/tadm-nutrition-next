const CallToActionBanner = () => {
  return (
    <div className="px-5">
      <div className="mx-auto flex max-w-screen-xl flex-col items-center justify-center gap-6 rounded-3xl bg-gradient-to-r from-blue-100 to-orange-100 p-10 text-center">
        <h2 className="text-3xl">Become better version of yourself</h2>
