...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      ...
      description,
      type: 'website',
      url: `${baseUrl}/${lang}/site/cannabis`,
    ...
    alternates: {
      canonical: `${baseUrl}/${lang}/site/cannabis`,
      languages: {
        en: `${baseUrl}/en/site/cannabis`,
        de: `${baseUrl}/de/site/cannabis`,
        'x-default': `${baseUrl}/en/site/cannabis`
      }
    }
  };
}
